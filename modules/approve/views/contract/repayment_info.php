...
<div class="zzsc zzsc_repayment_info" style="display:none;">
    <div class="tab">
            ...
            <li class="show" style="display:none;">
                <div class="dialog_box">
                    <form class="form repayment_add_from">
                        <ul style="border:0px;" class="repayment_add_from_head">
...
$(function(){
    // tab切换 mouseover
    $(".zzsc_repayment_info .tab a").click(function(){
        $(this).addClass('on').siblings().removeClass('on');
        var index = $(this).index();
        number = index;
        $('.zzsc_repayment_info .content .show').hide();
        $('.zzsc_repayment_info .content .show:eq('+index+')').show();
    });

    var loan_id = 0;
    $(".repayment_info").click(function(){
        $(".zzsc_repayment_info").css('display', 'block');
        ...
        $.get('/approve/ajax/get-repayment-info?loan_id='+loan_id+'&type_id=1', function(data){
            $(".repayment_add_from_head").empty().html(data);
        }, 'html');
