                ...
                <tr>
                    ...
                    <td align="center">
                        <?php if ($vo['is_admin'] != 1): ?>
                            ...
                            <a class="setedit" href="javascript:void(0);" onclick="layer.confirm('确认要删除该用户吗?',{icon:3,fix:true},function(index){layer.close(index);location.href='<?= Url::to(['manage/del', 'id' => $vo['id']]) ?>';});">删除</a>
